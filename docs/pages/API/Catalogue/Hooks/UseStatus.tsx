...
const transitions = {
    en: {
        ...
        step2: `Initially 'useWallet' needs to detect the wallet-injected Provider with the value 'in-detecting'. This process takes very little time, just a few ms, so you don't need to pay attention to this phase or write transition state on the UI for this phase.`,
    ...
    zh: {
        ...
        step2: `初始时 'useWallet' 需要探测钱包注入的 Provider，其值为 'in-detecting'。这一过程耗时极短，只需要几ms。所以你不需要关注这个阶段，也不需要为这个阶段写 UI 上的过渡状态。`,

...
import { useStatus, useAccount, useChainId, useBalance, connect, Unit, sendTransaction, typedSign, switchChain } from '@cfxjs/use-wallet-react/ethereum/Fluent';
        ...
        <>
            ...
            {!isChainMatch && (
                <>
                    ...
                    <button onClick={() => switchChain(`0x${(+TargetChain).toString(16)}`)}>Switch to Target Chain</button>
                </>
            )}
        </>
    );

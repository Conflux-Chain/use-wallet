...
declare class Emitter<T extends RPCMethod> {
    ...
    on: {
        <Key extends keyof State>(type: Key, handler: import("../utils/mitt").Handler<State[Key]>): void;
        (type: "*", handler: import("../utils/mitt").WildcardHandler<State>): void;
    };
    off: {
        <Key extends keyof State>(type: Key, handler?: import("../utils/mitt").Handler<State[Key]> | undefined): void;
        (type: "*", handler: import("../utils/mitt").WildcardHandler<State>): void;
    };
    clear: () => void;
